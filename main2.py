...
@function_tool
async def get_current_location_tool() -> str:
    """
...
@function_tool
async def get_current_week_day() -> str:
    """
...
@function_tool
async def tavily_web_search(query: str, max_results: int = 2) -> str:
    """
...
async def perform_taviliy_search(query: str) -> str:
    """
    ...
    agent = Agent(
        ...
        tools=[get_current_week_day, get_current_location_tool, tavily_web_search],
    )
...
if __name__ == "__main__":
    ...
    query = "Öffnungszeiten Hafenkiste"
    result = asyncio.run(perform_taviliy_search(query))
    print("Search Result:\n", result)
