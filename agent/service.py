...
class RealtimeAgent(Generic[Context], LoggingMixin):
    def __init__(
        ...
        wakeword: PorcupineWakeWord | None = None,
        ...
        if self.enable_wake_word:
            self.wakeword = wakeword if wakeword else PorcupineWakeWord.PICOVOICE
    ...
    def _build_wake_word_config_if_configured(self) -> WakeWordConfig | None:
        ...
        return WakeWordConfig(
            keyword=self.wakeword or PorcupineWakeWord.PICOVOICE,
